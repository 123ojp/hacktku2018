...
class UserProfile(AbstractUser):
    ...
    constellation = models.CharField(null=False, blank=False,max_length=20, choices=(('水瓶座','水瓶座'), ('雙魚座', '雙魚座'), ('牡羊座', '牡羊座'), ('金牛座', '金牛座'), ('雙子座', '雙子座'), ('巨蟹座', '巨蟹座'), ('獅子座', '獅子座'), ('處女座', '處女座'), ('天秤座', '天秤座'), ('天蠍座', '天蠍座'), ('射手座', '射手座'), ('摩羯座', '摩羯座')), default='水瓶座', verbose_name=u'喜愛水果')
...
class Readquestion(models.Model):
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE,verbose_name=u'所屬者',null=True)
    status = models.BooleanField(default=False,verbose_name=u'目前狀態')
